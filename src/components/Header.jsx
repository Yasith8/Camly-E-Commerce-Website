...
function Header() {
  return (
    <div>
        <header className=' h-screen md:w-auto pt-[5rem] mb-[6rem] px-6 md:pt-[5%] md:px-[4rem] flex flex-col md:items-center justify-between md:flex-row md:gap-3' id='home'>
        <div className='md:w-[50%]'>
            ...
            <p className='mt-5 text-[15px] md:text-[16px]'> Explore our extensive collection of cutting-edge cameras, lenses, and accessories that 
            ...
            <button className='mt-5 mb-4 px-10 py-4 bg-black text-white font-bold rounded-lg'>Explore</button>
        </div>
        <div className=''>
          <img src={drone1} alt="" className='w-[600px] h-auto p-3'/>
        </div>
        </header>
    </div>
  )
